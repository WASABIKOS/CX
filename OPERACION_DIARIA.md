...
| `outputs/comentarios_categorizados.xlsx` | Excel filtrable para revisar comentarios, categorías automática/final y `feedback_key`. |
...
- el HTML ofrece **Exportar comentarios categorizados** para revisar y filtrar
  la categoría automática, final y el comentario sin alterar el CSV.
